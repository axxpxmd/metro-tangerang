...
<body class="h-full antialiased selection:bg-neutral-200 selection:text-black flex flex-col">
    ...
    <!-- Footer Area -->
    <footer id="main-footer" class="bg-slate-50 border-t border-slate-200 py-12 mt-auto">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <!-- Grid Layout -->
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                <!-- Column 1: Info Brand -->
                <div class="space-y-4">
                    <span class="text-lg font-black tracking-tighter text-black">
                        METRO<span class="text-sky-700">TANGERANG</span>
                    </span>
                    ...
                    <p class="text-[10px] font-mono text-slate-400 uppercase leading-normal">
                ...
                <div>
                    <h3 class="font-mono text-[10px] font-bold tracking-widest text-slate-700 uppercase mb-4">KATEGORI</h3>
                    <ul class="space-y-2 text-xs text-slate-500 font-medium">
                        <li><a href="/category/metro" class="hover:text-sky-700 transition">Metro Tangerang</a></li>
                        <li><a href="/category/politik" class="hover:text-sky-700 transition">Politik & Pilkada</a></li>
                        <li><a href="/category/ekonomi" class="hover:text-sky-700 transition">Ekonomi & Bisnis</a></li>
                        <li><a href="/category/olahraga" class="hover:text-sky-700 transition">Olahraga</a></li>
                        <li><a href="/category/lifestyle" class="hover:text-sky-700 transition">Lifestyle & Kuliner</a></li>
                    </ul>
                </div>

                <!-- Column 3: Redaksi & Layanan -->
                <div>
                    <h3 class="font-mono text-[10px] font-bold tracking-widest text-slate-700 uppercase mb-4">REDAKSI & HUKUM</h3>
                    <ul class="space-y-2 text-xs text-slate-500 font-medium">
                        <li><a href="/tentang" class="hover:text-sky-700 transition">Tentang Kami</a></li>
                        <li><a href="/redaksi" class="hover:text-sky-700 transition">Info Redaksi</a></li>
                        <li><a href="/kontak" class="hover:text-sky-700 transition">Kontak Kami</a></li>
                        <li><a href="/pedoman" class="hover:text-sky-700 transition">Pedoman Siber</a></li>
                        <li><a href="{{ route('news.search') }}" class="hover:text-sky-700 transition">Cari Berita</a></li>
                    </ul>
                </div>

                <!-- Column 4: Kontak & Social Media -->
                <div>
                    <h3 class="font-mono text-[10px] font-bold tracking-widest text-slate-700 uppercase mb-4">HUBUNGI & IKUTI KAMI</h3>
                    <div class="space-y-3 mb-4">
                        <p class="text-xs text-slate-500 leading-none">
                            <span class="font-mono text-[9px] text-slate-400 block mb-0.5">EMAIL REDAKSI</span>
                            <a href="mailto:info@metrotangerang.com" class="font-bold text-slate-800 hover:text-sky-700 transition text-[11px]">info@metrotangerang.com</a>
                        </p>
                        <p class="text-xs text-slate-500 leading-none">
                            <span class="font-mono text-[9px] text-slate-400 block mb-0.5">LAYANAN WHATSAPP</span>
                            <a href="https://wa.me/6281234567890" class="font-bold text-slate-800 hover:text-sky-700 transition text-[11px]">+62 812-3456-7890</a>
                        </p>
                    </div>
                    <!-- Social Media Links -->
                    <div class="flex items-center gap-2 pt-1">
                        <a href="#" class="w-8 h-8 rounded-full border border-slate-200 flex items-center justify-center text-blue-600 hover:bg-blue-50 hover:border-blue-400 transition" title="Facebook">
                            <i class="fa-brands fa-facebook-f text-xs"></i>
                        </a>
                        <a href="#" class="w-8 h-8 rounded-full border border-slate-200 flex items-center justify-center text-pink-600 hover:bg-pink-50 hover:border-pink-400 transition" title="Instagram">
                            <i class="fa-brands fa-instagram text-xs"></i>
                        </a>
                        <a href="#" class="w-8 h-8 rounded-full border border-slate-200 flex items-center justify-center text-black hover:bg-slate-100 hover:border-black transition" title="Twitter / X">
                            <i class="fa-brands fa-x-twitter text-xs"></i>
                        </a>
                        <a href="#" class="w-8 h-8 rounded-full border border-slate-200 flex items-center justify-center text-red-600 hover:bg-red-50 hover:border-red-400 transition" title="YouTube">
            ...
            <!-- Divider & Copyright -->
            <div class="pt-8 border-t border-slate-200 flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left">
                <p class="text-[10px] text-slate-500 font-mono uppercase">&copy; {{ date('Y') }} Metro Tangerang. Seluruh hak cipta dilindungi.</p>
                <p class="text-[10px] text-slate-400 font-mono uppercase">Portal Berita Terpercaya Tangerang Raya</p>
            </div>
        </div>
    </footer>
